...
# Check if the model file exists; if not, train it on the fly
if not os.path.exists(MODEL_PATH):
    with st.spinner("Model file not found. Training model on the cloud..."):
        # Import your training function or run the script
        import train_model 
        # Assumes train_model.py has a function or runs execution on import
