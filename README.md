...
🏗️ Foundations & Features
The project is built on the following core pillars:

Data Cleaning: Handling null values and outliers in clinical metrics.

Feature Engineering: Scaling numerical data to ensure model stability.

Classification: Implementing supervised learning algorithms to distinguish between diabetic and non-diabetic cases.

Performance Metrics: Detailed evaluation using Accuracy, Precision, and Recall.
